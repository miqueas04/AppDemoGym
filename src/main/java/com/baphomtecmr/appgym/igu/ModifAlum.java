...
public class ModifAlum extends javax.swing.JFrame {

    Controladora control = null;
    Alumno alumno = new Alumno();
    
    public ModifAlum(int idAlumno) {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(65, 65, 65)
                        .addComponent(btnModif, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(106, 106, 106)
   ...
   LocalDate fechaLimite = fechaInicial.plusDays(diasDispo);
        ...
        control.editarAlumno(alumno, fechaIngreso, nombre, diasDispo, edad, peso, altura, dni, cel, direc, observaciones, fechaLimite);
        
         mostrarMensaje ("Alumno Editado", "Info", "Exito al Editar alummno");
         
         ConsultaEbaj consul = new ConsultaEbaj();
   ...
   public void mostrarMensaje (String mensaje, String tipo, String titulo){
    ...
    private void cargarDatosAlumno(int idAlumno) {
        ...
        alumno = control.traeAlumno(idAlumno);
        
        txtNomb.setText(alumno.getNombre());
        txtDias.setText(String.valueOf(alumno.getDiasDispo()));
        txtEdad.setText(String.valueOf(alumno.getEdad()));
        txtPeso.setText(alumno.getPeso());
        txtAltura.setText(String.valueOf(alumno.getAltura()));
        txtDni.setText(String.valueOf(alumno.getDni()));
        txtCel.setText(alumno.getCel());
        txtDirec.setText(alumno.getDirec());
        txtObser.setText(alumno.getObservaciones());
